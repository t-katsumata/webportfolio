...
onMounted(() => {
  ...
  container.value?.querySelectorAll(".timeline-item").forEach((el, i) => {
...
<template>
        ...
        <div class="timeline-item" v-for="(item, index) in biography" :key="index" :class="{ active: activeIndex === index }">
          ...
          <dd class="timeline-content">
            <figure class="timeline-image">
              <img :src="`${item.imageUrl}`" alt="" width="320" height="240" />
            </figure>
  ...
  <CommonSection class="@container">
    ...
    <p class="mt-8">仕事以外でも新しい発見やインスピレーションを大切にしています。</p>
    <ul class="grid grid-cols-1 @lg:grid-cols-2 @4xl:grid-cols-3 mt-10 @lg:gap-[3.623%] gap-8">
      <li class="grid place-content-start">
        ...
        <figure class="order-1">
          <img src="../assets/images/about-walking.jpg" width="800" height="450" alt="" />
        </figure>
      ...
      <li class="grid place-content-start">
        ...
        <figure class="order-1">
          <img src="../assets/images/about-sports.jpg" width="800" height="450" alt="" />
        </figure>
      ...
      <li class="grid place-content-start">
        ...
        <figure class="order-1">
          <img src="../assets/images/about-music.jpg" width="800" height="450" alt="" />
        </figure>
